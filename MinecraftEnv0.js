...
//observation:
//  botx, boty, [closestExists_i, closestX_i, closestZ_i]
...
module.exports = class MinecraftEnv extends EnvironmentServer
{
  ...
  {
    this.bot.clearControlStates();
    this.cursor = new Vec3(1, 0, 0);//idk

    this.bot.chat("/clear");
    this.bot.chat("/xp -999999999L @p");
    this.bot.chat("/kill");
    await new Promise((res) => setTimeout(res, 100)); //TODO: configurable delay?

    this.bot.chat("/give @p diamond_sword");
    //this.bot.chat("/give @p dirt 64");
